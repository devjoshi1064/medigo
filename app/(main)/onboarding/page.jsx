...
const OnboardingPage = () => {
    ...
    useEffect(() => {
        if (data && data?.success) {
            toast.success("Role Selected Successfully! Redirecting...");
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                >
                    <CardContent className="pt-6 pb-6 flex flex-col items-center text-center">
                        ...
                        <Button
                            className="w-full mt-2 bg-emerald-600 hover:bg-emeral d-700"
                            disabled={loading}
                        >
                            {loading ? (
                                <>
    ...
    if (step === "doctor-form") {
        return (
            <Card className="border-emerald-900/20 px-6 py-8">
